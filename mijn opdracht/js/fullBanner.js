...
let volnion   = document.querySelector('.fb_volnion');
...
const animeren = () => {
    ...
    setTimeout( () => {volnion.classList.remove('fb--uit')}, 300);
...
//banner linken//
const gaNaarPagina = () => window.open('http://www.wall.volnion.nl', '_blank');
